...
def poblar_bd(request):
    ...
    Producto.objects.create(codProducto="5", nomProducto='GSkill Trident Z',        imagen="images/ram/001/001.png", imagen2="images/ram/001/001c.png",      precioProducto="59990"  , precioProductoCred="59990", descFich="lala"  ,descFichCom="lala",                  categoria=Categoria.objects.get(idCategoria=1))
    Producto.objects.create(codProducto="6", nomProducto='MSI GeForce GTX 1660 GAMING X 6G',         imagen="images/Video/001/001.png",      precioProducto="289990", precioProductoCred="289990",                 descFich="lala"  ,descFichCom="lala",                 categoria=Categoria.objects.get(idCategoria=1))
    return redirect(producto, action='ins', id = '-1')
